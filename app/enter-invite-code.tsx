...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: colors.background }, flex: { flex: 1 }, content: { padding: spacing.lg, gap: 16 }, title: { color: colors.text, fontSize: 24, fontWeight: '800' }, subtitle: { color: colors.textSecondary, fontSize: 13, lineHeight: 19, marginTop: 5 }, card: { gap: 13 }, label: { color: colors.text, fontSize: 13, fontWeight: '700' }, input: { minHeight: 56, borderWidth: 1, borderColor: colors.borderStrong, borderRadius: radii.small, color: colors.text, backgroundColor: colors.white, paddingHorizontal: 14, fontSize: 20, fontWeight: '800', letterSpacing: 2, textAlign: 'center' }, requestLabel: { color: colors.textMuted, fontSize: 9, fontWeight: '800', letterSpacing: 0.8 }, name: { color: colors.text, fontSize: 20, fontWeight: '800', marginTop: 6 }, meta: { color: colors.textSecondary, fontSize: 12, marginTop: 4 }, explain: { color: colors.textSecondary, fontSize: 12, lineHeight: 18, marginTop: 14 }, actions: { gap: 8, marginTop: 16 }, error: { color: colors.redDark, backgroundColor: colors.redSoft, borderRadius: 10, padding: 11, fontSize: 12 },
});
