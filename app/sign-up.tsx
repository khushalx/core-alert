...
const styles = StyleSheet.create({
  ...
  intro: { flexDirection: 'row', alignItems: 'center', marginVertical: 12 }, icon: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.blueSoft, alignItems: 'center', justifyContent: 'center' }, introCopy: { flex: 1, marginLeft: 12 }, title: { color: colors.text, fontSize: 21, fontWeight: '800' }, subtitle: { color: colors.textSecondary, fontSize: 12, lineHeight: 17, marginTop: 3 },
  card: { gap: 14 }, field: { gap: 7 }, label: { color: colors.text, fontSize: 13, fontWeight: '700' }, helper: { color: colors.textSecondary, fontSize: 11, lineHeight: 16, marginTop: 3 }, input: { minHeight: 50, borderWidth: 1, borderColor: colors.borderStrong, borderRadius: radii.small, color: colors.text, backgroundColor: colors.surfaceElevated, paddingHorizontal: 13, fontSize: 14 }, multiline: { minHeight: 78, paddingTop: 12, textAlignVertical: 'top' }, error: { color: colors.redDark, backgroundColor: colors.redSoft, borderRadius: 10, padding: 11, fontSize: 12, lineHeight: 18 },
