...
const styles = StyleSheet.create({
  ...
  intro: { flexDirection: 'row', alignItems: 'center', marginBottom: 6 }, icon: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#E8EEF4', alignItems: 'center', justifyContent: 'center' }, introCopy: { flex: 1, marginLeft: 12 }, title: { color: colors.text, fontSize: 20, fontWeight: '800' }, subtitle: { color: colors.textSecondary, fontSize: 12, lineHeight: 17, marginTop: 3 },
  card: { paddingBottom: 4 }, field: { marginBottom: 16 }, label: { color: colors.text, fontSize: 13, fontWeight: '700', marginBottom: 7 }, input: { minHeight: 52, borderWidth: 1, borderColor: colors.borderStrong, borderRadius: radii.small, color: colors.text, backgroundColor: colors.white, paddingHorizontal: 13, fontSize: 14 },
